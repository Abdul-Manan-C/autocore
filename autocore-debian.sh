...
#  Version : 1.0
#  Platform: Debian / Ubuntu / Parrot OS
# ============================================================
...
EOF
echo -e "${RESET}"
echo -e "${CYAN}${BOLD}         [ AUTOCORE v1.0 | Automated Pentest Orchestrator | Debian/Ubuntu/Parrot ]${RESET}"
...
ok "Session: $SESSION"
echo -e "  ${DIM}Mode: $MODE | Target: $TARGET | Platform: Debian/Ubuntu/Parrot${RESET}\n"
ensure_tools
...
# AUTOCORE Metasploit Notes — $TARGET (Debian/Ubuntu/Parrot)
